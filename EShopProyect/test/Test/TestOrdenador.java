...
class TestOrdenador {
	...
	@Test
	void testPulgadas() {
		Ordenador o = new Ordenador("", 0, 0, "" , "", "", Categoria.CUALQUIERA, 32.1, "1920x1080", 16, 500, "Amarillo");
	...
	void testAlmacenamiento() {
		Ordenador o = new Ordenador("Camiseta", 11.1, 21, "Manga larga" , "camiseta.jpg", "Adidas", Categoria.CUALQUIERA, 32.1, "1920x1080", 16, 500, "Amarillo");
